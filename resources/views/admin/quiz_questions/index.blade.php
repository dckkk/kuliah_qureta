            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/quiz_questions', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($quiz_questions as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/admin/quiz_questions', $item->id],
                            ...
                            <div class="pagination-wrapper"> {!! $quiz_questions->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
