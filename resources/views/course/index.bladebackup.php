...
<meta name="twitter:site" content="{{ url('/course/'.$course->_slug) }}">
						...
						<div class="row">
							...
							<div class="col-md-3" id="video-bottom" style="height: 1907px;">
								<ul class="nav nav-tabs materi">
									<li class="active"><a data-toggle="tab" href="#materi">Materi_</a></li>
								</ul>
		    ...
		    <div class="modal-dialog" role="document">
		        <div class="modal-content">
		            ...
		            <div class="modal-footer">
		                ...
		                <a class="btn btn-danger" href="/enrollNow/{{$slug}}">Daftar Sekarang</a>
		            </div>
		        </div>
		    </div>
		</div>
